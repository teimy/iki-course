...
На этом репозитории будут выкладываться лекции и задания по мере их написания; Шкалу оценки за весь курс и проектную деятельность и многое другое можно найти в [FAQ.md](https://github.com/teimy/iki-course/blob/master/FAQ.md)
...
Github изначально заточен на взаимодействие с [гитом](https://ru.wikipedia.org/wiki/Git) - самой распространненой системой версионного контроля. Если вы хотите познать дзен гита, вы вряд ли найдете что-то лучше чем [git-scm](https://git-scm.com/book/ru/v2).

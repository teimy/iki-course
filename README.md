...
Github изначально заточен на взаимодействие с [гитом](https://ru.wikipedia.org/wiki/Git) - самой распространненой системой версионного контроля. Если вы хотите познать дзен гита, то вы вряд ли найдете что-то лучше чем [git-scm](https://git-scm.com/book/ru/v1/%D0%9E%D1%81%D0%BD%D0%BE%D0%B2%D1%8B-Git).
